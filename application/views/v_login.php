...
<div class="col-md-6">
  <form action="menu.html" method="post" role="form" class="php-email-form p-3 p-md-4">
    <div class="section-header">
        ...
        <div class="form-group">
          <input type="password" class="form-control" name="password"  placeholder="Password" id="subject" required>
        </div>
    ...
    <div class="text-center"><a href="Login.html"><button type="submit"><i class="fa fa-list"></i> Masuk</button></a></div>
  </form>
  <!--End Contact Form -->
